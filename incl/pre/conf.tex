...
\lstdefinestyle{custompy}{
  ...
  otherkeywords={},
  morekeywords={},
  deletekeywords={data,frame,length,as,character,par,min,model,function,df,split, list, library, grid, residuals, sqrt, int, qqnorm, qqline, close, nrow, replace, which, quantile, seq, by, for, filled, if, fitted, qnorm, start, end, ts, args, weights, coef, c, na, rm, all, D, order, numeric, mean}
}
